...
import type { GetApiSearchData } from "@/api/generated/in/index.js";
import { zGetApiSearchQuery } from "@/api/generated/in/zod.gen.js";

const searchRouter = Router();

async function handleSearch(
  req: Request<unknown, unknown, unknown, GetApiSearchData["query"]>,
  res: Response
): Promise<void> {
  try {
