...
function buildThemeQueryPrompt(query: string): string {
  return [
    ...
    "Treat user queries case-insensitively. Capitalization may be noisy, so phrases like Grand Theft Auto, Grand theft auto, and grand theft auto refer to the same franchise.",
    ...
    "Examples: grand theft auto / Grand Theft Auto -> TTWO; rockstar games / Rockstar Games -> TTWO; toy story / Toy Story -> DIS; pixar / Pixar -> DIS; alexa / Alexa -> AMZN; universal pictures / Universal Pictures -> CMCSA; playstation / PlayStation -> SONY; call of duty / Call of Duty -> MSFT; trucks -> F, GM, PCAR; wood products -> WY, LPX, UFPI; movies -> DIS, CMCSA, SONY, NFLX, WBD; videogames -> TTWO, EA, RBLX, NTDOY, SONY.",
